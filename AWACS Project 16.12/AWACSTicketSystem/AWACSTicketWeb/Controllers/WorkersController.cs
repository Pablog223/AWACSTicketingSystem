...
namespace AWACSTicketWeb.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,WorkerId,Name,Surname,eMail,Password,Department,AdminRole,UserRole")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,WorkerId,Name,Surname,eMail,Department")] Worker worker)
        {
            if (ModelState.IsValid)
            {
