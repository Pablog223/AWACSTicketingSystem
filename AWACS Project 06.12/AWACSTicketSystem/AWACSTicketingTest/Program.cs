...
//assignment of responsibles per ticket to the list
            ...
            Console.Write(Max.WorkerID);

            bool first = true;
            foreach (var Created in Max.Created)
            {
                if (first)
                {
                    Console.Write(" is the creator of the ticket ");
            ...
            foreach (var Created in Max.Responsible)
            {
                if (firstagain)
                {
                    Console.Write(" is the responsible for the ticket ");
                    Console.Write(Max.Responsible);
                    firstagain = false;
                }
                else
                {
