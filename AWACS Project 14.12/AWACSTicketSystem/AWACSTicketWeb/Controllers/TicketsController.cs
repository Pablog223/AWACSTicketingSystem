...
namespace AWACSTicketWeb.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {
            ViewBag.CreatorId = new SelectList(db.WorkerSet.Select(m => m.WorkerId));
            ViewBag.ResponsibleId = new SelectList(db.WorkerSet.Select(m => m.WorkerId));
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Category,Description,Solution,DateObserved,PlannedEndDate,Progress,Status,CreatorId,ResponsibleId")] Ticket ticket)
        {
            ...
            ViewBag.CreatorId = new SelectList(db.WorkerSet, "Id", "Name", ticket.CreatorId);
            ViewBag.ResponsibleId = new SelectList(db.WorkerSet, "Id", "Name", ticket.ResponsibleId);
            return View(ticket);
        }
